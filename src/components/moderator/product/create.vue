<template>
  <b-container fluid style="text-align:right;">
              ...
              <b-col sm="12" v-if="product.newPieces.hasDiscount">
                ...
                >
                  <datepicker
                    style="width:100%"
                    placeholder="تاريخ انتهاء التخفيض"
                    v-model="product.newPieces.discountEnd"
                    name="DisCountEnd"
                  ></datepicker>
                </b-form-group>
              </b-col>
    ...
    margin: 50px;">
      ...
      <button type="submit" class="btn btn-block btn-success">انشاء منتج</button>
    </b-form>
  </b-container>
</template>
...
export default {
  ...
  methods: {
    ...
    selectChanged(e, i) {
      ...
      this.product.newPieces.attributes[
        i
      ].attr_value.ar = this.product.attributes[i].attr_values[
        selectedValueIndex
      ].ar;
      this.product.newPieces.attributes[
        i
      ].attr_value.en = this.product.attributes[i].attr_values[
        selectedValueIndex
      ].en;
